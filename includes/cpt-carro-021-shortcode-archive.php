...
<div class="fix1667408457 <?php echo $fix_color_situacao ?>">
	...
	<div class="fix1667408548" style="text-align: left;">
		...
		<div class="fix_field_"><h2><a href="?p=<?php echo $row['ID'] ?>"><?php echo $row['fix1693416443_model'] ?></a></h2></div>
		...
		<div class="fix_field"><?php echo $row['fix1693416443_color'] ?></div>

		<div class="fix_label">Preço:</div>
		<div class="fix_field"><?php echo $row['fix1693416443_price'] ?></div>
